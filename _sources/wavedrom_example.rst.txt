...
There is a plugin for ``sphinx`` called ``sphinxcontrib-wavedrom`` which adds support for embedding ``WaveDrom`` graphs
...
#. Make sure you have the ``sphinx`` plugin for ``wavedrom`` (installable via ``pip``)
...
WaveDrom Short Turorial
~~~~~~~~~~~~~~~~~~~~~~~

A tutorial for `WaveDrom <https://wavedrom.com>`_ can be found `here <https://wavedrom.com/tutorial.html>`_.
...
.. wavedrom:: wavedrom_example.json
